            ...
            for appon_array in ['ch1', 'ch2', 'ch5', 'ch4', 'ch3']:
                for boolean in [True, False]:
                    ...
                    for scp_idx, scp_instance_results in enumerate(ih_array):
                        ...
                        # Obtain the results
                        initial_solution, initial_cost, final_solution, final_cost, history = lsh(ih_results_array=scp_instance_results, scp_instances_dir=scp_instances_dir, random_seed=42, initial_temperature=1000, final_temperature=0.001, cooling_ratio_alpha=0.99, tabu_thr=10)
