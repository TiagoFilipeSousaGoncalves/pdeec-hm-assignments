...
# Custom Imports
from local_search_heuristics import lsh2
...
if test_result == 0:
    ...
    for lsh_idx, lsh in enumerate([lsh2]):
        print("Current: LSH{}".format(lsh_idx+2))
        ...
        for input_results_array in ['ih_1', 'ih_2', 'ih_3', 'ih_4']:
            for appon_array in ['ch1', 'ch2', 'ch5', 'ch4', 'ch3']:
                for boolean in [True, False]:
                    ...
                    results_array_filename = 'lsh_{}_appon_{}_and_{}_processed_solution_{}.npy'.format(lsh_idx+2, input_results_array, appon_array, boolean)
